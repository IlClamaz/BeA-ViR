...
namespace RenderHeads.UnityOmeka.Data.Vocabularies
{
    ...
    public class Property
    {
        ...
        public static Property FromJObject(JObject jObject)
        {
            Property p = new Property()
            {
                ...
                DisplayTitle = jObject["display_title"]?.ToString(),
                ValueResourceId = jObject["value_resource_id"]?.ToObject<int?>(),
                //Medium = jObject["medium"]?.ToString(),
                //Square = jObject["square"]?.ToString(),
                //Large = jObject["large"]?.ToString(),
            };
            return p;
        }
    }
    ...
    public class DublicCoreVocabulary : Vocabulary
    {
        ...
        //vmurtas
        public Property[] ArchaeomHasArchaeometricInvestigation;
        public Property[] ArchaeomHasInterpretationDetails;
        public Property[] ArchaeomHasInterpretationTerm;

        //public Property[] ThumbnailDisplayUrls;
        ...
        public override void ApplyVocabulary(JObject rootObject)
        {
            ...
            ArchaeomHasArchaeometricInvestigation = Property.FromRoot(rootObject, "archaeom:hasArchaeometricInvestigation");
            ArchaeomHasInterpretationDetails = Property.FromRoot(rootObject, "archaeom:hasInterpretationDetails");
            ArchaeomHasInterpretationTerm = Property.FromRoot(rootObject, "archaeom:hasInterpretationTerm");
            //ThumbnailDisplayUrls = Property.FromRoot(rootObject, "thumbnail_display_urls");
        }
    }
}